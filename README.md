...
<p align="center">
  <img src="./.github/images/project-infrastructure.png" alt="Pipeline of the System" width="80%" height="80%">
</p>

### A. Server and Infrastructure Structure

- **Amazon Web Services (AWS) EC2**
  - Hosting: The entire system is hosted on AWS EC2 instances.
- **Go Server**
  - Technology: Built using the Go language.
  - Communication: Uses WebSockets for real-time communication with web applications; interacts with the FastAPI Server.
- FastAPI Server
  - Technology: Developed using Python with FastAPI.
  - Functionality: Handles asynchronous task processing and data exchange with the Go server.
- ChatGPT Server
  - Role: Manages AI chat agents.
  - Integration: Communicates with web applications via the FastAPI Server.

### B. Web Application and User Interface

Responsibilities: Manages user interface, static file distribution, and HTTP request processing.

### C. Deployment and Operational Optimization

- Nginx
  - Role: Functions as the web server.
- Docker and Docker Compose
  - Usage: Used for standardizing and automating the service environment.
- GitHub Actions
  - Application: Automates deployment to EC2.

## How to Run

You can run the project locally using Docker Compose or run separate services.
...
And you have to set the environment variables.

```env
OPENAI_API_KEY="YOUR_API_KEY"
GO_SERVER_URL="ws://127.0.0.1:8443/withGPT"
```
...
I'm recommending using [air](https://github.com/cosmtrek/air) to run the Go server.
...
I'm using [pnpm](https://pnpm.io/) to manage the dependencies.
...
> 정형화된 인공지능 기술과 키치 문화를 김치처럼 **'뒤범벅'** 시킵니다. 그들은 이제 졸업을 해야 합니다. 졸업은 인공지능이 대신 못 해주거든요.
